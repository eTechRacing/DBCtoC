...
# Obrir una finestra per seleccionar el fitxer .dbc
root = tk.Tk()
...
if not output_folder_h:
    sys.exit("No s'ha seleccionat cap carpeta per al fitxer .h.")  # Si no s'escull cap carpeta, sortir

# Crear i desar el fitxer header
header_file = os.path.join(output_folder_h, f"{file_name}.h")
...
if not output_folder_c:
    sys.exit("No s'ha seleccionat cap carpeta per al fitxer .c.")  # Si no s'escull cap carpeta, sortir

# Crear i desar el fitxer source
source_file = os.path.join(output_folder_c, f"{file_name}.c")
